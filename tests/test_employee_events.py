...
#### YOUR CODE HERE
project_root = path("/workspace/dsnd-dashboard-project/dsnd-dashboard-project/")
...
def db_path():
    ...
    #### YOUR CODE HERE
    return project_root/env_1/python-package/employee_events/employee_events.db
...
def test_employee_table_exists(table_names):
    ...
    #### YOUR CODE HERE
    assert 'employee' in table_names True
...
def test_team_table_exists(table_names):
    ...
    # is in the table_names list
    #### YOUR CODE HERE
    assert 'team' in table_names True
...
def test_employee_events_table_exists(table_names):
    ...
    # is in the table_names list
    #### YOUR CODE HERE
    assert 'employee_events' in table_names True
